...
//                    casillasView[x, y] = new CasillaView(graphicsDevice, x, y,
//                        graphicsDevice.Viewport.Height / 8,
//                        color,
//                        tileset
//                    );
//                    casillas[x, y].Subscribe(casillasView[x, y]);
//                }
//            }
...
//            foreach (CasillaView casilla in casillasView)
//                casilla.Draw(_spriteBatch);
//        }
//        private void ColocarPiezas() {
//            //peones blancos
//            for (int i = 0; i < 8; i++)
//                casillas[i, 6].Ficha = new Peon(0);
//            ////peones negros
//            for (int i = 0; i < 8; i++)
//                casillas[i, 1].Ficha = new Peon(1);
//            //torres blancas
//            casillas[7, 7].Ficha = new Torre(0);
//            casillas[0, 7].Ficha = new Torre(0);
//            //torres negras
//            casillas[7, 0].Ficha = new Torre(1);
//            casillas[0, 0].Ficha = new Torre(1);
//            //alfiles blancos
//            casillas[2, 7].Ficha = new Alfil(0);
//            casillas[5, 7].Ficha = new Alfil(0);
//            //alfiles negros
//            casillas[2, 0].Ficha = new Alfil(1);
//            casillas[5, 0].Ficha = new Alfil(1);
//            //caballos blancos
//            casillas[1, 7].Ficha = new Caballo(0);
//            casillas[6, 7].Ficha = new Caballo(0);
//            //caballos negros
//            casillas[1, 0].Ficha = new Caballo(1);
//            casillas[6, 0].Ficha = new Caballo(1);
//            //reina blanca
//            casillas[3, 7].Ficha = new Reina(0);
//            //reina negra
//            casillas[3, 0].Ficha = new Reina(1);
//            //rey blanco
//            casillas[4, 7].Ficha = new Rey(0);
//            //rey negro 
...
//                    casillas[registroJugada.f.X - 1, registroJugada.f.Y].Ficha = new Torre(registroJugada.fichaOrigen.Lado);
//                } else {  ////IZQUIERDA
...
//                    casillas[registroJugada.f.X, registroJugada.o.Y].Ficha = new Peon(registroJugada.fichaOrigen.Lado * (-1) + 1);
//                //SI HUBO ENROQUE
...
//                    //IZQUIERDA
//                    else {
//                        casillas[registroJugada.f.X - 2, registroJugada.f.Y].Ficha = new Torre(registroJugada.fichaOrigen.Lado);
//                        casillas[registroJugada.f.X + 1, registroJugada.f.Y].Ficha = null;
//                    }
//                }
//            }
